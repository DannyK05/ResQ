...
const ModSpecial = () => {
    return(
        <section className="w-[90vw] bg-white py-[10px] px-[15px] rounded-[20px] z-10 absolute shadow shadow-black top-[30%] left-[5vw]">
           
           <h1>Manage your password <ion-icon name="close-circle"></ion-icon></h1>
            <form>
