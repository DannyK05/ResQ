    ...
    return(
        <nav className="fixed w-[100%] z-10 bg-white border-t border-slate-100 bottom-0 px-2 py-3">
            <ul className="flex w-[100%] justify-between align-center ">
               <Link to="/" > <li><ion-icon name={activeNav ? "home" : "home-outline"}></ion-icon></li></Link>{/*Change Link address to home when Login page is ready*/}

                <li>{visibility ? 
                <ion-icon onClick={toggleEmergencyTab} name="close-outline"></ion-icon> 
                : 
