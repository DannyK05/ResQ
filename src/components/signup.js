  ...
  return (
    <section>
      ...
      <form onSubmit={handleSubmit}>
        <input
          className="border-[1px] border-[#E7DDDD] p-[5px] rounded-lg active:border-[#2592F6] hover:border-[#2592F6]  m-[10px] w-[40%] "
        ...
        />
        <input
          className="border-[1px] border-[#E7DDDD] p-[5px] rounded-lg active:border-[#2592F6] hover:border-[#2592F6]  m-[10px] w-[80%] "
          onChange={handleChange}
          type="email"
          name="email"
        ...
        <button
          ...
          } active:text-blue border-neutral-400 rounded-xl bg-blue mx-[5px] my-[15px] px-[50px] py-[5px] w-[95%] text-white`}
          disabled={formError !== ""}
          type="submit"
        >
