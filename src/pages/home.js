...
const Home = () => {
    ...
    return (
        <HomeLayout>
            ...
            <Advice />
            <ActionBtn />
            <div className={`${visibility ? '' : 'hidden'} absolute z-10 bg-white p-4 w-[90%] ml-4 shadow shadow-black  rounded-[20px]`}>
                <img className="w-full my-2" src={Permission} alt="Turn on location" />
